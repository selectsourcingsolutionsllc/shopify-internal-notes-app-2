  ...
  return (
    <div style={{ maxWidth: "800px", margin: "0 auto", padding: "40px 20px", fontFamily: "system-ui, sans-serif" }}>
      ...
      <p>
        ...
        collects, uses, and protects information in connection with the Internal Notes App for
        Shopify ("the App").
      </p>
      <p>
      ...
      <p>We collect information you provide directly to us when using the Internal Notes App, including:</p>
      <ul>
      ...
      <ul>
        <li>Provide, maintain, and improve the Internal Notes App and its features</li>
